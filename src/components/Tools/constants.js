...
export const ITEMS = [
  {
    ...
    types: [ITEM_TYPES.all, ITEM_TYPES.evidence]
  },
  {
    id: "ghostWritingBook",
  ...
  },
  {
    ...
    displayShort: "Photo",
    category: ITEM_CATEGORIES.starter,
    types: [ITEM_TYPES.all, ITEM_TYPES.evidence, ITEM_TYPES.objectives, ITEM_TYPES.special]
  },
  {
    id: "emfReader",
    display: "EMF Reader",
  ...
  },
  {
    ...
    category: ITEM_CATEGORIES.starter,
    types: [ITEM_TYPES.all, ITEM_TYPES.evidence, ITEM_TYPES.light]
  },
  {
    id: "flashlight",
    display: "Flashlight",
    displayShort: "Light",
    category: ITEM_CATEGORIES.starter,
    types: [ITEM_TYPES.all, ITEM_TYPES.light]
  },
  {
    id: "objectiveBoard",
    ...
    types: [ITEM_TYPES.all, ITEM_TYPES.tools]
  },
  {
    id: "siteMap",
    display: "Site Map",
  ...
  },
  {
    ...
    types: [ITEM_TYPES.all, ITEM_TYPES.photos, ITEM_TYPES.special]
  },
  {
    id: "voodooDoll",
    display: "Voodoo Doll",
    ...
    category: ITEM_CATEGORIES.onsite,
    types: [ITEM_TYPES.all, ITEM_TYPES.photos]
  },
  {
    id: "boneEvidence",
  ...
  },
  {
    ...
    category: ITEM_CATEGORIES.purchasable,
    types: [ITEM_TYPES.all, ITEM_TYPES.junk]
  },
  {
    ...
    category: ITEM_CATEGORIES.purchasable,
    types: [ITEM_TYPES.all, ITEM_TYPES.junk, ITEM_TYPES.light]
  },
  {
    id: "lighter",
    display: "Lighter",
    ...
    category: ITEM_CATEGORIES.purchasable,
    types: [ITEM_TYPES.all, ITEM_TYPES.light, ITEM_TYPES.tools]
  },
  {
    id: "motionSensor",
    ...
    category: ITEM_CATEGORIES.purchasable,
    types: [ITEM_TYPES.all, ITEM_TYPES.objectives]
  },
  {
  ...
  },
  {
    ...
    displayShort: "Salt",
    category: ITEM_CATEGORIES.purchasable,
    types: [ITEM_TYPES.all, ITEM_TYPES.objectives, ITEM_TYPES.evidence]
  },
  {
    id: "sanityPills",
  ...
  },
  {
    ...
    displayShort: "Smudge",
    category: ITEM_CATEGORIES.purchasable,
    types: [ITEM_TYPES.all, ITEM_TYPES.objectives, ITEM_TYPES.tools]
  },
  {
    id: "soundSensor",
  ...
  },
  {
    ...
    displayShort: "Tripod",
    category: ITEM_CATEGORIES.purchasable,
    types: [ITEM_TYPES.all, ITEM_TYPES.other, ITEM_TYPES.tools]
  },
]